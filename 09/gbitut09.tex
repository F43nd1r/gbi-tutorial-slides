...
\begin{frame}[t]{Wahr oder Falsch?}
	...
	\FalseQuestionE{\enquote{Wenn Person $a$ Person $b$ mag, mag $b$ nicht unbedingt $a$.} \\ $\equiv \plall \word a \plall \word b \, \plka \word{mag(a,b)} \alimpl \alnot \word{mag(b,a)}\plkz $}{Richtig wäre $\alnot \plall \word a \plall \word b \,\plka \word{mag(a,b)} \alimpl \word{mag(b,a)}\plkz $. \\ Umgeformt: „Es gilt nicht unbedingt, dass wenn $a$ $b$ mag, dann auch $b$ $a$ mag.“}
...
\xkcdframevert{835}{Frohe Weihnachten und bis nächstes Jahr!}{2.2}
