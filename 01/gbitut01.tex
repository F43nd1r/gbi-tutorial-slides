...
\begin{frame}[t]{Was machen wir hier?}
	\begin{itemize}[<+->]
		\item Tut-Folien bekommt ihr im \ILIAS.
		\item Inhalte der VL verstehen und anwenden
		\item Beispiele, Aufgaben
	    ...
	    \item Wenn ich / meine Folien Blödsinn reden: \\
		      Melden! / Mail an mich! \impl Sonst kann ich's nicht fixen... \\
...
\begin{frame}[t]{Leistungen}
	\begin{itemize}
		\item \textbf{Übungsschein}: \\
			  bestanden, wenn 
			  \begin{itemize}
			  	\item 50~\% der Punkte der Übungsblätter 1-6 \textbf{und}
			  	\item 50~\% der Punkte der Übungsblätter 7-12
			  \end{itemize}
		  erreicht \\
	...
	\DependsQuestionE{Muss ich den Schein machen?}{
		Infos, InWis, Info-Lehramt: \quad  Ja \quad
		{\small Physiker u.a.:} \quad Vielleicht nicht (?) \\
...
\begin{frame}{Übungsblätter}
	\begin{itemize}
		\item \textbf{Ausgabe}: in der zweiten Wochenhälfte im \ILIAS \\
			  \hstretchto{\textbf{Ausgabe}:}{\textbf{Abgabe}:} Dienstag, 12:30~Uhr, im GBI-Kasten im U-Geschoss des Infobaus
		\pause
		\item Handschriftlich, \\ 
		mit \textbf{Deckblatt} (Tutoriums-Nr. \mytutnumber\  drauf!), \\ 
		\textbf{getackert} abgeben!
		\item Rechtzeitig! 
		\item \textbf{Keine} Plagiate \pause
		\item Gruppenabgabe: Nur für Blätter 1-6
		\pause
		\item \textbf{Rückgabe}: Hier im Tut \\ (Nach ca. zwei Wochen Abholung beim Lehrstuhl)
	\end{itemize}
\end{frame}
...
\begin{frame}{Übungsblätter}
	...
	\begin{itemize}
		...
		\item Links und rechts bitte einen Rand frei lassen. \\
			  Dann kann ich's auch korrigieren.
...
\begin{frame}{Fragen? Hilfe?}	
	\begin{block}{Fragen}
		\begin{itemize}
			...
			\item Ins \ILIAS. (Dann haben alle was davon) \\
			\pause
	...
	\begin{block}{Content}
		\begin{itemize}
			...
			\item Archiv: \url{http://gbi.ira.uka.de/archiv/index.html} \\
...
%% Letzte Seite 
\xkcdframevert{2042}{Danke für eure Aufmerksamkeit!}{2.5}
