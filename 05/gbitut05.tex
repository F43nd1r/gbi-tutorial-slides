...
\begin{frame}{Rückblick}
	...
	\end{itemize}\pause
	Ein Alphabet selbst ist \textbf{auch} ne formale Sprache, nämlich mit Wörtern der Länge 1.\\\pause
	Klarstellung: Indizes vs. Potenzen: $L_1 \neq L^1$, $L_2 \neq L^2$
\end{frame}
...
\xkcdframe{571}{Danke für eure Aufmerksamkeit!}{2.5} % Zweierkomplement
